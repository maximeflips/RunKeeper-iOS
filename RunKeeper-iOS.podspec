#
#  Be sure to run `pod spec lint RunKeeper-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Tiago Alves" => "alvesjtiago@gmail.com" }
  s.social_media_url = 'https://twitter.com/_iterar'
  # Or just: s.author    = "Tiago Alves"
  # s.authors            = { "Tiago Alves" => "alvesjtiago@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Tiago Alves"
